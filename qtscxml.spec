...
Version  : 5.15.17
Release  : 34
URL      : https://download.qt.io/official_releases/qt/5.15/5.15.17/submodules/qtscxml-everywhere-opensource-src-5.15.17.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.15/5.15.17/submodules/qtscxml-everywhere-opensource-src-5.15.17.tar.xz
...
%prep
%setup -q -n qtscxml-everywhere-src-5.15.17
cd %{_builddir}/qtscxml-everywhere-src-5.15.17
...
ASFLAGS="$CLEAR_INTERMEDIATE_ASFLAGS"
LDFLAGS="$CLEAR_INTERMEDIATE_LDFLAGS"
export SOURCE_DATE_EPOCH=1748668497
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtscxml
cp %{_builddir}/qtscxml-everywhere-src-%{version}/LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtscxml/61907422fefcd2313a9b570c31d203a6dbebd333 || :
cp %{_builddir}/qtscxml-everywhere-src-%{version}/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtscxml/e93757aefa405f2c9a8a55e780ae9c39542dfc3a || :
cp %{_builddir}/qtscxml-everywhere-src-%{version}/LICENSE.LGPL3 %{buildroot}/usr/share/package-licenses/qtscxml/f45ee1c765646813b442ca58de72e20a64a7ddba || :
cp %{_builddir}/qtscxml-everywhere-src-%{version}/tests/3rdparty/scion-tests/LICENSE.txt %{buildroot}/usr/share/package-licenses/qtscxml/7df059597099bb7dcf25d2a9aedfaf4465f72d8d || :
cp %{_builddir}/qtscxml-everywhere-src-%{version}/tests/3rdparty/scion-tests/scxml-test-framework/LICENSE.txt %{buildroot}/usr/share/package-licenses/qtscxml/7df059597099bb7dcf25d2a9aedfaf4465f72d8d || :
export GOAMD64=v2
GOAMD64=v2
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmlcompiler_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmlcppdatamodel_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmldatamodel_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmlecmascriptplatformproperties_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmlevent_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmlexecutablecontent_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmlglobals_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmlinvokableservice_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmlstatemachine_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmlstatemachineinfo_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qscxmltabledata_p.h
/usr/include/qt5/QtScxml/5.15.17/QtScxml/private/qtscxml-config_p.h
...
/usr/lib64/libQt5Scxml.so.5.15.17
